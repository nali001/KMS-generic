...
def openCrawlerConfig(webSiteEntity):
    ...
    crawlerConfig = open(os.getcwd()+'/medical-crawlerConfig.json',"r")
...
def extractHTMLbyRendering(url):
    ...
    if config['render_html']:
        ...
        # print("HERE IS THE PATH: " + os.getcwd()+"/../ChromeDriver/chromedriver")
        driver = webdriver.Chrome("/var/lib/opensemanticsearch/ChromeDriver/chromedriver", options=chrome_options)
        driver.get(url)
        time.sleep(2)
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    # enableTestModel("paperswithcode-datasets", "https://paperswithcode.com/dataset/imagenet")
    enableTestModel("kaggle-datasets", "https://www.kaggle.com/datasets/paultimothymooney/breast-histopathology-images")
